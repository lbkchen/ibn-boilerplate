...
import maria from "../images/About_17_Maria.png";
...
<b>Open Hours: </b>Monday - Friday, 9 AM - 5 PM. Our center’s hours will be extended throughout the semester. <br/>
         ...
         <img className="about-img" src={about_center}></img>
          ...
          <div className="left">
            ...
            <h1>Our Background</h1>
              ...
              <p>The quality of life of our students has a major impact on their sense of belonging, persistence, graduation, and overall experience. Therefore, we refuse to accept hunger, malnourishment, and homelessness as part of our university.</p>
              <p>Basic Needs is committed to accomplishing food, housing and economic justice on the UC Berkeley campus through a robust model of prevention, intervention and emergency relief efforts. Our goal is to ensure that UC Berkeley is a Basic Needs Secure campus. Our prevention efforts thus far have included pre-college education, first year student outreach and messaging around Basic Needs, as well as Basic Needs skill development such as NST 20 lecture, and nutrition and cooking demonstration. Emergency interventions include the UC Berkeley Food Pantry which provides emergency food relief. Crisis interventions include the Food Assistance Program which provides eligible students with financial support for food, as well as the Emergency Housing Support program.</p>
        ...
        <div className="right">
         <img className="about-img" src={about_background}></img>
        </div>
          ...
          <div className="about-page-team ">
            ...
            <div className="about-page-team-container">
              ...
              <div className="about-page-team-row">
                ...
                <div className="about-page-team-column">
                  <div className="about-page-team-card">
                    <img className="about-page-team-img" src={maria} alt="Img"  />
                    <div className="about-page-team-text-container">
            ...
            <div className="about-page-focus-container">
              ...
              <div className="about-page-focus-row">
                {/* column */}
                  ...
                  <div className="focus-img"><img className="about-focus-img" src={about_food_supp}></img></div>
                  ...
                  <div className="about-page-focus-card">
                  <div className="focus-img"><img className="about-focus-img" src={about_housing}></img></div>
                    <div className="about-page-focus-text-container">
              ...
              {/* row */}
                  ...
                  <div className="about-page-focus-card">
                  <div className="focus-img"><img className="about-focus-img" src={about_econ}></img></div>
                    <div className="about-page-focus-text-container">
